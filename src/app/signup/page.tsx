...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/50 to-slate-100 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <p className="mt-2 text-sm text-slate-500 font-medium">Start managing SME Payroll effortlessly</p>
      </div>
        ...
        <div className="glass-card py-8 px-4 sm:rounded-2xl sm:px-10">
          <form action={handleSubmit} className="space-y-6">
            ...
            <div className="pt-2">
              ...
              >
                {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Create Account Securely"}
              </button>
            </div>
          </form>

          <div className="mt-8 pt-6 border-t border-slate-100 text-center text-sm">
            <Link href="/login" className="font-semibold text-slate-500 hover:text-indigo-600 transition-colors">
